...
class RulesEngine:
    ...
    def get_rule_definitions() -> list:
        ...
        return [
            ...
            {"rule_id": "SUB-009", "rule_name": "Filename-Content Consistency", "category": "submission", "severity": "medium", "description": "Document filenames should match their actual content. Mismatches may indicate mislabeled or incorrect documents."},
            # IFTA
