...
async def get_submission(submission_id: str, db: Session = Depends(get_db)):
    ...
    return SubmissionDetailResponse(
        ...
        assigned_team=submission.assigned_team,
...
def _to_response(s: Submission, doc_count: int) -> SubmissionResponse:
    return SubmissionResponse(
        ...
        assigned_team=s.assigned_team, assigned_to=s.assigned_to,
        review_status=s.review_status, review_notes=s.review_notes,
